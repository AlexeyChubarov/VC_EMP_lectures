...
\begin{gather*}
	...
	F\in\Cfn{2},\ x\in[a,b],\ |y|<M,\ \forall y';\quad \K=\left\{y(x)|y\in\Cfn[{[a,b]}]{1},\ |y|<M\right\}
\end{gather*}
...
\begin{equation}
	\label{l3:eq:9}
	\hfill \delta\J=t\left\{\int\limits_a^b\left(F_y-\der{}{x}F_{y'}\right)\cdot\eta\,dx+F_{y'}\cdot\eta\mathop{\Big|}\limits_a^b\right\}\hfill
\end{equation}
