...
Пусть $u(x,t)$ --- решение уравнения~\eqref{l19:eq:10_} и
\begin{equation*}
	\mc{D}=\left\{x,t\middle|0\leqslant x\leqslant l,\; 0\leqslant t\leqslant T\right\},
\end{equation*}
здесь $T$ --- произвольное фиксированное число. Положим $\Gamma=PA\cup AB\?\cup BC$ и пусть $u\in\Cfn[(\mc{D}\backslash \Gamma)]{2}$.
...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
	...
	% Text Node
	\draw (183.89,65.4) node [anchor=north west][inner sep=0.75pt]    {$t$};
	% Text Node
