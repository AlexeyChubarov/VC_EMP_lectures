...
\begin{equation}
	\label{l2:eq:19}
	\hfill E[y]=g\cdot\int\limits_{-l}^{+l}\rho\cdot\sqrt{1+y^{\prime2}}\cdot y\,dx+\frac12\cdot\int\limits_{-l}^{+l}\frac{\mu\cdot y^{\prime\prime2}}{\left(1+y^{\prime2}\right)^{3/2}}\,dx.\hfill
\end{equation}
...
\begin{multline*}
	\text{Найти }\min\limits_{y\in\K}\,E[y], \text{ где } E[y]=\int\limits_{-l}^{+l}\left(g\cdot\rho\cdot y+\frac{1}{2}\cdot\mu\cdot y^{\prime\prime2}\right)\,dx,\\ \K=\left\{y(x)|y\in\Cfn[{[a,b]}]{2},\ y(l)=y'(l)=y(-l)=y'(-l)=0\right\}_{\displaystyle.}
\end{multline*} 
