...
\begin{equation*}
	\hfill \fL\eqdef\left\{y(x)|\int\limits_a^b|y|^2\,dx<+\infty\right\}.\hfill
\end{equation*}
...
и
\begin{equation*}
	\hfill\Ul=\left\{y(x)|y\in\mc{D}_{\LL},\ Ly=\lambda\cdot y\right\}.\hfill
\end{equation*}
...
где 
\begin{equation*}
	\hfill Ly=-\der{}{x}\big(Q\cdot y'\big)+P\cdot y,\quad\mc{D}_{L}=\left\{y(x)|y\in\Cfn[{[a,b]}]{2},\ y(a)=y(b)=0\right\}.\hfill
\end{equation*}
...
\begin{_teor}
	...
	\begin{equation*}
		\hfill\displaystyle\K_p\eqdef\left\{y(x)|y\in\K_1,\ \big(y,y_j\big)=0,\,j=\overline{1,p-1}\right\}.\hfill
	\end{equation*}
...
\begin{equation*}
	\hfill\K_{p}=\left\{y(x)|y\in\K_1,\ \big(y,y_j\big)=0,\,j=\overline{1,p-1}\right\}\hfill
\end{equation*}
