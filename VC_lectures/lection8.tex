...
Прежде чем её формулировать{\mb,} рассмотрим пример, подсказывающий{\mb,} како{\mbго} поведени{\mbя} собственных значений обобщённой задачи Штурма можно ожидать при росте $\rho(x)$. Пусть $\lambda_k$ и $y_k$, $k=1,2,\ldots${\mb~---\\---}  собственные значения и собственные функции оператора Штурма:
\begin{equation*}
